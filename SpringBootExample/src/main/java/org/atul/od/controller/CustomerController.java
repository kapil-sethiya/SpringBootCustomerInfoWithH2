package org.atul.od.controller;

import java.util.List;

import org.atul.od.model.Customer;
import org.atul.od.service.CustomerService;
...
public class CustomerController {
	...
	@RequestMapping(value="/getCustomerByName/{customerName}",method = RequestMethod.GET,headers="Accept=application/json")
	public String findCustomerByName(@PathVariable("customerName") String customerName,Model model)
	{
		//List<Customer> clist=this.customerService.getAllCustomersByName(customerName);
		model.addAttribute("customer",new Customer());
		//model.addAttribute("listOfCustomers",clist);
		return "customerDetails";
	}
